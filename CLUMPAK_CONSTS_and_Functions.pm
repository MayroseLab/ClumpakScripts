...
use constant RESULTS_DIR_ABSOLUTE_PATH => "/bioseq/data/results/CLUMPAK";
use constant RESULTS_DIR_SECURE_PATH => "https://clumpak.tau.ac.il/CLUMPAK_results";
use constant RESULTS_DIR_NON_SECURE_PATH => "http://clumpak.tau.ac.il/CLUMPAK_results";
use constant RESULTS_LINK => "CLUMPAK_results";
use constant LOG_FILE => "output.log";
use constant DAILY_TEST_STRUCTURE_FILE => "/bioseq/CLUMPAK/Structure_toy_data_tiny.zip";
...
use constant LOG_DIR_ABSOLUTE_PATH => "/bioseq/data/results/CLUMPAK/logs/";
